...
export default function Signup() {
  ...
  return (
    ...
    bg-gradient-to-br from-hero-start from-0% via-hero-end via-65% to-hero-mid p-4 font-sans gap-20">
      ...
      <div className="w-full max-w-md bg-white rounded-[32px] shadow-2xl p-8 md:p-10 flex flex-col items-center">
       ...
       <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-accent 
                focus:border-transparent transition-all placeholder:text-gray-400 text-gray-700"/>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-12 py-3.5 bg-white border border-gray-200
                 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-accent
                 focus:border-transparent transition-all placeholder:text-gray-400 text-gray-700"/>
        ...
        <div className="w-full grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center space-x-2 py-3 px-4 border
           border-gray-200 rounded-2xl hover:bg-gray-50 transition-colors duration-200">
            <span className="text-sm font-bold text-gray-700">Google</span>
          </button>
          <button className="flex items-center justify-center space-x-2 py-3 px-4 border border-accent 
          rounded-2xl hover:bg-amber-50/30 transition-colors duration-200">
