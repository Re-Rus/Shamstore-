...
export default {
  ...
  theme: {
    ...
    colors: {
  // Main layout colors
  background: "var(--background)",     // Application's main background color (Neutral/Warm White)
  foreground: "var(--foreground)",     // Default text color for high readability (Basalt Black)
  
  // Brand identity colors
  primary: "var(--primary)",           // Core brand color used for main UI elements (Mediterranean Blue)
  secondary: "var(--secondary)",       // Complementary brand color for supporting elements (Palmyra Sand)
  accent: "var(--accent)",             // Call-to-action and highlight color (Qasioun Gold)
